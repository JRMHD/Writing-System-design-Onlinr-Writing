...
@section('content')
    ...
    <div class="container">
        <h1><i class="fas fa-crown"></i> Active Subscriptions</h1>
        @if (session('success'))
        ...
        @if ($subscriptions->isEmpty())
            <p style="font-size: 18px; color: #333; text-align: center;"><i class="fas fa-info-circle"></i> No active
                subscriptions.</p>
        @else
        ...
        <div style="text-align: center; margin-top: 40px;">
            <a href="{{ route('subscriptions.plans') }}" class="back-btn">
