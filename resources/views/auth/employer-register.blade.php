...
<body class="bg-gray-100 min-h-screen flex items-center justify-center py-12">
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-bold text-deep-orange">Employer Registration</h1>
            <p class="text-gray-600 mt-2">Create your employer account</p>
        </div>
        ...
        <p class="mt-6 text-center text-gray-600">
            ...
            <a href="{{ route('employer.login') }}"
                class="text-royal-blue hover:underline transition duration-300">Login here</a>
        </p>
