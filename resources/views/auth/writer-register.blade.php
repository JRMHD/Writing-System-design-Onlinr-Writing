...
<body class="bg-light-gray min-h-screen flex items-center justify-center py-12">
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-semibold text-upwork-green">Writer Registration</h1>
            <p class="text-text-gray mt-2">Create your writer account</p>
        </div>
            ...
            <div>
                ...
                <div class="relative">
                    <input type="password" id="password" name="password" placeholder="••••••••" required
                        class="w-full px-4 py-2 border rounded-md border-gray-300 focus:outline-none focus:ring-2 focus:ring-upwork-green transition duration-300">
                    <button type="button"
                        class="togglePassword absolute inset-y-0 right-0 pr-3 flex items-center text-sm leading-5">
        ...
        <p class="mt-6 text-center text-text-gray">
            ...
            <a href="{{ route('writer.login') }}"
                class="text-upwork-green hover:underline transition duration-300">Login
                here</a>
        </p>
