...
@section('content')
    <div class="container" style="max-width: 900px; margin: 0 auto; padding: 2rem;">
        <!-- Title -->
        <h1 style="color: var(--deep-orange); font-size: 2.5rem; margin-bottom: 2.5rem; text-align: center;">Edit Assignment
        </h1>
        ...
        <form action="{{ route('employer.assignments.update', $assignment->id) }}" method="POST"
            ...
            <div class="form-group" style="margin-bottom: 2rem;">
                ...
                <textarea class="form-control" id="description" name="description" rows="6" required
                    style="width: 100%; padding: 1rem; border: 1px solid #ccc; border-radius: 0.75rem; font-size: 1rem; transition: border-color 0.3s ease;">{{ $assignment->description }}</textarea>
            </div>
