...
@section('content')
    <div style="font-family: Arial, sans-serif; max-width: 1000px; margin: 0 auto; padding: 20px;">
        ...
        <h1 style="color: #14a800; font-size: 24px; margin-top: 40px; margin-bottom: 20px;">Completed Assignments</h1>
        ...
        <table
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="4" style="padding: 20px; text-align: center; color: #666;">No completed assignments
                            found.</td>
                    </tr>
                @endforelse
            </tbody>
