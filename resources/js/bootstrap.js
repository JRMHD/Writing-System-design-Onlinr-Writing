...
window.Echo = new Echo({
    broadcaster: "pusher",
    key: process.env.MIX_PUSHER_APP_KEY, // Use the MIX prefix for Laravel Mix
    cluster: process.env.MIX_PUSHER_APP_CLUSTER, // Use the MIX prefix for Laravel Mix
    encrypted: true,
    // Optional: You can configure transport options
